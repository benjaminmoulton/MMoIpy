...
if __name__ == "__main__":
    ...
    axs_Ims[1].plot(RT  ,Is [0,1,1],"k-",label=uslbl)
    # axs_Ims[1].plot(RT  ,Is [1,1,1],"k--",label=lnlbl)
    axs_Ims[1].plot(RTSW,IW   [1,1],"w.",mec="k",mew=0.5,label=SWlbl)
    axs_Ims[2].plot(RT  ,Is [0,2,2],"k-",label=uslbl)
    # axs_Ims[2].plot(RT  ,Is [1,2,2],"k--",label=lnlbl)
    axs_Ims[2].plot(RTSW,IW   [2,2],"w.",mec="k",mew=0.5,label=SWlbl)
